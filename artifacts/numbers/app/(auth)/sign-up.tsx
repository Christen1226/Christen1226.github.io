...
import { useSSO, useSignUp, useAuth } from "@clerk/expo";
...
export default function SignUpScreen() {
  ...
  const handleSSOSignUp = useCallback(async (strategy: "oauth_google" | "oauth_apple") => {
    ...
    try {
      ...
      setLocalError(err?.message ?? "Social sign-up failed");
    } finally {
      setSsoLoading(null);
    }
  }, [startSSOFlow]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.subtitle}>Track your dancers at every competition</Text>
        ...
        <View style={styles.socialGroup}>
          ...
          >
            {ssoLoading === "google"
              ...
              : (
                <>
                  <View style={styles.iconWrapper}><Text style={styles.googleG}>G</Text></View>
          ...
          >
            {ssoLoading === "apple"
              ...
              : (
                <>
                  <View style={styles.iconWrapper}><Text style={styles.appleA}></Text></View>
        ...
        <View style={styles.switchRow}>
          ...
          <Link href="/(auth)/sign-in" asChild>
            <Pressable><Text style={styles.switchLink}>Sign in</Text></Pressable>
          </Link>
        </View>
      </ScrollView>
      {/* Required for bot protection */}
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontFamily: "Inter_700Bold", color: WHITE, marginBottom: 6 },
  subtitle: { fontSize: 14, fontFamily: "Inter_400Regular", color: MUTED, marginBottom: 32 },
  ...
  socialBtnText: { fontSize: 15, fontFamily: "Inter_600SemiBold", color: LAVENDER },
  iconWrapper: { width: 24, height: 24, alignItems: "center", justifyContent: "center" },
  googleG: { fontSize: 16, fontFamily: "Inter_700Bold", color: "#4285F4" },
  appleA: { fontSize: 18, color: WHITE, lineHeight: 22 },
  ...
  primaryBtnText: { fontSize: 16, fontFamily: "Inter_600SemiBold", color: WHITE },
  errorText: { fontSize: 12, fontFamily: "Inter_400Regular", color: RED, marginBottom: 8 },
  switchRow: { flexDirection: "row", justifyContent: "center", marginTop: 24 },
  switchText: { fontSize: 14, fontFamily: "Inter_400Regular", color: MUTED },
  switchLink: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: LAVENDER },
  linkRow: { alignItems: "center", marginTop: 16 },
  linkText: { fontSize: 14, fontFamily: "Inter_400Regular", color: LAVENDER },
});
