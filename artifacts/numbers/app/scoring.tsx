...
export default function ScoringScreen() {
  ...
  const handlePublish = async () => {
    ...
    setPublishing(true);
    await uploadScoring(pendingImage);
    setPublishing(false);
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { paddingTop: topPad + 8 }]}>
        ...
        <View style={styles.headerCenter}>
          <Text style={[styles.headerTitle, { color: colors.foreground }]}>SCORING</Text>
          {competition && (
        ...
        {scoringImages.length > 0 ? (
          ...
          >
            ...
            <View style={[styles.uploadPill, { backgroundColor: colors.violet }]}>
              ...
              <Text style={[styles.uploadPillText, { color: colors.foreground }]}>Upload Document</Text>
            </View>
          </Pressable>
        ) : (
